-- drop table RESOURCES_MSISDN purge;
 
Create table RESOURCES_MSISDN(
ACCOUNT_NO VARCHAR2(150) not null,
CUST_ID NUMBER(22) not null,
MSISDN NUMBER(22) ,
MSISDN_VALID_FROM DATE not null,
MSISDN_VALID_TO DATE ,
IP_ADDR NUMBER(22) ,
IP_ADDR_VALID_FROM DATE not null,
IP_ADDR_VALID_TO DATE ,
--PRIMARY KEY (CUST_ID)
...
FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT) TABLESPACE "PINTABLE" ;
 CREATE INDEX idx_RESOURCES_MSISDN_ACCOUNT_NO ON RESOURCES_MSISDN(ACCOUNT_NO);