-- drop table PR_SERV_STATUS_HIST purge;
 
Create table PR_SERV_STATUS_HIST(
...
REASON NUMBER(22) not null,
TRANSACTIONNO NUMBER(22) not null,
VALID_FROM_DATE DATE ,
ENTRY_DATE DATE not null,
REQUEST_ID NUMBER(22) ,
REC_VERSION NUMBER(22) ,
USER_REASON NUMBER(22) ,
AGE_OUT_DATE DATE ,
--PRIMARY KEY (CUST_ID)
...
FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT) TABLESPACE "PINTABLE" ;
 CREATE INDEX idx_PR_SERV_STATUS_HIST_ACCOUNT_NO ON PR_SERV_STATUS_HIST(ACCOUNT_NO);